...
raster_cube(gefs_cube, v_orig) |> 
   gdalcubes::select_bands("TMP") |> 
   slice_time(datetime = "2022-12-05 06:00:00") |>
   st_as_stars() |> 
...
and we can use all the classic manipulation techniques available in stars.
...
neon <- raster_cube(gefs_cube, v) |> 
       slice_time(datetime = "2022-12-05 06:00:00") |>
       st_as_stars() |>
       st_extract(sites) # use st_coordinates(sites) for simple array


y <-  raster_cube(gefs_cube, v) |> 
      gdalcubes::select_bands("TMP") |> 
      st_as_stars() |> 
      split() |> 
      st_extract(sites) |> 
...
We can also perform much richer calculations with `reduce_time`, `reduce_space`,
