...
options("mc.cores"=2L) # 11min w/ 31 cores, 5.32 hrs on 1 core.  on top of gdalcubes parallel use of of all cores


stage1_stats <- gefs4cast::gefs_s3_dir("stage1-stats")
